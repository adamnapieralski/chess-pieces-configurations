...
void shell::Shell::setPiecesConfig() {
...
void shell::Shell::displayMainMenu() {
    std::cout << "MENU\n\n";
...
void shell::Shell::displaySettings() {
...
void shell::Shell::displayDescription() {
